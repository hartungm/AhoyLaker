...
public class Diagnostics : NSObject
{
	...
	*/
	class func platformString() -> (device: String, desciption: String, number: Int?) {
		...
		case "iPhone3,3": return ("iPhone", "iPhone 4", 4)
		case "iPhone4,1": return ("iPhone", "iPhone 4", 4)
			//iPhone 5's
		case "iPhone5,1": return ("iPhone", "iPhone 5", 5)
		case "iPhone5,2": return ("iPhone", "iPhone 5", 5)
		case "iPhone5,3": return ("iPhone", "iPhone 5", 5)
		case "iPhone5,4": return ("iPhone", "iPhone 5", 5)
		case "iPhone6,1": return ("iPhone", "iPhone 5", 5)
		case "iPhone6,2": return ("iPhone", "iPhone 5", 5)
			//iPhone 6's
